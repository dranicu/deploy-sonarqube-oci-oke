...
variable "deploy_sonarqube" {
  type        = bool
  default     = true
  description = "Controls the deployment of the SonarQube helm chart."
}

variable "sonarqube_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the SonarQube helm chart defaults and those generated by Terraform using the templates."
}
